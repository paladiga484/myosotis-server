...
public class HttpResponseFormat<T> where T : new()
{
    ...
    public UpdatedFormat updated { get; set; } = new();
    public T result { get; set; } = new();
    public SynchronizedFormat synchronized { get; set; } = new();
    public long packetId { get; set; }
}
...
public class ServerErrorCodeManager
{
    ...
    public Dictionary<int, ServerErrorCodeStaticData> _errorCodeMap { get; set; }
}
